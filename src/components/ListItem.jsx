    ...
    return (
        <>
            <tr className='border border-orange-400 h-10'>
                ...
                <td className='flex justify-around pt-3 text-lg'><BsTrash3Fill className="cursor-pointer" color="red" onClick={()=>delHandler(id)} /><BsCalendarCheckFill className="cursor-pointer" color="green" onClick={doneHandler} /></td>
            </tr>
        </>
    )
}
